		...
		<div id="container">
			<div id="output">
				<div class="containerT">
					<h1>用户注册</h1>
					<form class="form" id="entry_reform" name="register" action="<%=path%>/check_register.jsp" method="post" onsubmit="return validate()">
						<input type="text" class="userid" name="Userid" placeholder="账号" id="entry_id" />
						<input type="text" class="username" name="Username" placeholder="用户名" id="entry_name" />
						<input type="password" class="password" name="Password" placeholder="密码" id="entry_password" />
						<input type="password" class="repassword" name="rePassword" placeholder="再次输入密码" id="entry_repassword" />
						<button type="submit" id="entry_REGbtn" class="register">注册</button>
